...
//10:
//11:
//12:升级状态：0不升级 1正在连接wifi 2正在连接TCP 3传输中
//13:标志位：0正常 1避障 2跟随 最高位为PID调节和RGB调节切换 PID 0x80 RGB 0x00
//--------------------------------------

// 2.4G接收数据缓存数组
volatile extern u8 RF2G4_Receive_Data[14];
//--------------------------------------
//标志位定义：
//0:UP
//1:DOWN
...
//---------------------------------------------------------------
//SI24R1连接
#define 	RF2G4_CE   		PBout(1) 	// SI24R1选信号
#define 	RF2G4_CSN  		PBout(0) 	// SPI片选信号
#define 	RF2G4_IRQ  		PAin(4)  	// IRQ主机数据输入
